...
from keras.layers import Lambda,Merge,TimeDistributed,BatchNormalization,PReLU,Dropout,Input
...
data_1 = sequence.pad_sequences(sequences_1, maxlen=MAX_SEQUENCE_LENGTH)
data_2 = sequence.pad_sequences(sequences_2, maxlen=MAX_SEQUENCE_LENGTH)
